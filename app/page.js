...
export default function Home() {
  ...
  useEffect(() => {
    const timerIn = setTimeout(() => setAutoPopup(true), 8000);
    const timerOut = setTimeout(() => setAutoPopup(false), 12000);
  ...
  useEffect(() => {
    ...
    setAutoPopup(true)
    const timer = setTimeout(() => setAutoPopup(false), 3000) 
        ...
        <div className="fixed bottom-4 right-4 block lg:hidden z-40">
          <button
            ...
            onClick={() => {
              ...
              setTimeout(() => setLanguageButton(false), 2000);
            }}
          >
            <AnimatePresence>
