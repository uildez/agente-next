...
export const Header = () => {
  ...
  return (
    <div className='flex relative w-full flex-col gap-12 items-center pt-20 lg:pt-20 pb-20 lg:pb-40 px-8 lg:px-20 2xl:px-40'>
      ...
      <Image className="absolute w-[300px] rotate-12 left-20 he-float" src={animation3d === true ? "/images/mascots/he-blink.webp" : "/images/mascots/he.webp"} alt="3D Uildes Mascot" width={500} height={500} />
      <Image className="absolute w-[300px] -rotate-20 right-20 bottom-10 she-float" src={animation3d === true ? `/images/mascots/she-star.webp` : `/images/mascots/she-very-happy.webp`} alt="3D Uildes Mascot" width={500} height={500} />
    </div>
  )
}
