  ...
  return (
    <div className='flex flex-col rounded-4xl p-8 w-full px-8 lg:px-20 2xl:px-40 font-nexa'>
      <div className='flex flex-col relative bg-pink rounded-4xl px-8 lg:px-20 pt-20 pb-8 w-full'>
        <Image src="/svg/he-star.svg" className='absolute top-0 left-0 w-[250px] lg:w-[300px]' alt="A Gente Mascot" width="200" height="200" />
        <div className='flex items-center mt-[200px] lg:mt-0 lg:ml-[400px]'>
