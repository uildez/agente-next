...
export const About = () => {
  ...
  return (
    <section ref={ref} className="relative h-[300vh]" id="about-us">
      <div className="sticky top-0 flex flex-col lg:flex-row items-start justify-center h-screen px-8 pt-40 gap-20 lg:px-20 2xl:px-40 overflow-hidden">
        ...
        <div className="w-full lg:w-3/5 relative">
          ...
          <div className="relative w-full h-auto min-h-[450px] overflow-hidden rounded-4xl">
            <motion.div
              style={{ clipPath: sheClip }}
